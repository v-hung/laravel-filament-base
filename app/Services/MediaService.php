...
class MediaService
{
	...
	public function deleteMedia(Media $media): bool
	{
		try {
			...
			$mediaFolder = $this->getMediaDirectory($media->id);
			if (Storage::disk($media->disk)->exists($mediaFolder)) {
				Storage::disk($media->disk)->deleteDirectory($mediaFolder);
			}
	 ...
	 */
	protected function getMediaDirectory(int $mediaId): string
	{
