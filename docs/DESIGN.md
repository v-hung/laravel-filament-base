...
Registered as `--font-sans` in `@theme`, so `font-sans` resolves to Manrope automatically.
...
| --------------------- | ---- | ------------ | ----------- | -------------------------------- |
| `.text-h-80-bold`     | 80px | Bold 700     | 110%        | Extra-large hero displays        |
...
| `.text-h-40-semibold` | 40px | SemiBold 600 | 120%        | Page titles — softer variant     |
| `.text-h-40-bold`     | 40px | Bold 700     | 120%        | Page titles, major section heads |
...
| `.text-h-20-semibold` | 20px | SemiBold 600 | 120%        | Labels, small headings           |
...
| `.text-p-16-medium`   | 16px | Medium 500   | 160%        | Standard UI text — medium weight |
| `.text-p-16-regular`  | 16px | Regular 400  | 160%        | Standard body text               |
| `.text-p-14-bold`     | 14px | Bold 700     | 145%        | Small UI text — strong emphasis  |
...
All button classes include `tracking-[2%]` letter-spacing.

| Class          | Size | Weight     | Line Height | Tracking | Use for           |
| -------------- | ---- | ---------- | ----------- | -------- | ----------------- |
| `.text-btn-14` | 14px | Medium 500 | 100%        | 2%       | Small buttons     |
| `.text-btn-16` | 16px | Medium 500 | 100%        | 2%       | Standard buttons  |
| `.text-btn-18` | 18px | Medium 500 | 100%        | 2%       | Large/CTA buttons |
...
<!-- Body paragraph -->
<p class="text-p-16-semibold text-duyang-grey">
    We source sustainable materials.
</p>

<!-- Muted metadata -->
<span class="text-p-14-regular text-duyang-grey-mid"
    >12 products · Updated Jan 2025</span
>

<!-- Button labels -->
<span class="text-btn-14">Details</span>
<span class="text-btn-16">Shop now</span>
<span class="text-btn-18">Get started</span>
```
...
<div class="min-h-screen surface-page">...</div>
...
<div class="bg-duyang-white p-12">
    <h3 class="mb-4 text-h-24-bold text-duyang-black">Title</h3>
    <p class="text-p-16-semibold text-duyang-grey">
...
```html
<div class="min-h-screen surface-page px-13 pt-13 pb-17.5">
    <!-- Body -->
    <main class="flex flex-wrap gap-16 p-16">
        <div class="bg-duyang-white p-12">...</div>
    </main>
</div>
```
...
```html
<section>
    <h1 class="mb-6 text-h-56-bold text-duyang-black">Headline</h1>
    <p class="mb-3 text-p-18-semibold text-duyang-grey">
        Lead paragraph, semi-bold.
    </p>
    <p class="text-p-16-semibold text-duyang-grey">Standard body copy.</p>
    <span class="text-p-14-regular text-duyang-grey-mid"
        >Metadata or secondary info.</span
    >
</section>
```
...
```html
<button class="text-btn-14 text-duyang-grey">Details</button>
<button class="text-btn-16 text-duyang-black">Shop now</button>
<button class="bg-duyang-black text-btn-18 text-duyang-white">
    Get started
</button>
```
