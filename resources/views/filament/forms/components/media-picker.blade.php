<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div x-data="{
        ...
        <template x-if="!mediaItems || mediaItems.length === 0">
            @if ($isCompact())
                <button type="button" @click="openPicker()"
                    class="flex items-center justify-center w-full h-9 px-3 border border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors">
