            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="shop_sidebar_searchbar position-relative">
                        <input class="rounded-pill" type="search" name="search" placeholder="Tìm kiếm">
                                ...
                                <div class="row">
                                    <div class="form-check">
                                        ...
                                        <div class="col">
                                            ...
                                            <label class="form-check-label ms-2" for="flexCheckDefault10">
                                                Noodles, Sauces
                                            </label>
                                        </div>
                                        <div class="col">
                                            ...
                                            <label class="form-check-label ms-2" for="flexCheckDefault11">
                                                Personal Care
                                            </label>
                                        </div>
                                        <div class="col">
                                            ...
                                            <label class="form-check-label ms-2" for="flexCheckDefault12">
                                                Pet Care
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <!-- filter range start -->
                    <div class="price-range-area mt-3" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <section class="trending_sec mt-3" data-aos="fade-up" data-aos-duration="2000">
                        <div class="trending_sec_wrap">
                            ...
                            <div class="trending_item d-flex align-items-center">
                                <div class="trending_thumb d-flex justify-content-center align-items-center">
                                    <img src="assets/images/trends/trend7.png" alt="image_not_found">
                                </div>
                            ...
                            <div class="trending_item d-flex align-items-center">
                                <div class="trending_thumb d-flex justify-content-center align-items-center">
                                    <img src="assets/images/trends/trend8.png" alt="image_not_found">
                                </div>
                                <div class="trending_text">
                            ...
                            <div class="trending_item d-flex align-items-center">
                                <div class="trending_thumb d-flex justify-content-center align-items-center">
                                    <img src="assets/images/trends/trend9.png" alt="image_not_found">
                                </div>
                                <div class="trending_text">
                                    <span>Broccoli</span>
                                    <div class="trending_price">
                            ...
                            <div class="trending_item d-flex align-items-center">
                                <div class="trending_thumb d-flex justify-content-center align-items-center">
                                    <img src="assets/images/trends/trend10.png" alt="image_not_found">
                                </div>
                                <div class="trending_text">
                            ...
                            <div class="trending_item d-flex align-items-center">
                                <div class="trending_thumb d-flex justify-content-center align-items-center">
                                    <img src="assets/images/trends/trend11.png" alt="image_not_found">
                                </div>
                                <div class="trending_text">
                            ...
                            <div class="trending_btn mt-3">
                                <a href="#"><button type="button" class="btn text-uppercase px-4">View More
                            ...
                            <div class="container">
                                <div class="filter_area d-flex justify-content-between align-items-center mb_30">
                                    <ul class="nav layout_tab_nav ul_li" role="tablist">
                                        <li>
                                            <button class="active" data-bs-toggle="tab" data-bs-target="#grid_layout"
                                        ...
                                        <li>
                                            <button data-bs-toggle="tab" data-bs-target="#list_layout" type="button"
                                ...
                                <div class="shop_product_list">
                                    <div class="tab-content" id="pills-tabContent">
                                                        ...
                                                        <div class="product_layout_content bg-white position-relative">
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    href="product-detail.html" target="_blank">
                                                                    <img class="pic-1"
                                                            ...
                                                            <div class="rating_wrap d-flex">
                                                                ...
                                                                <span class="shop_review_text">( 4.0
                                                                    )</span>
                                                            </div>
                                                            <div class="product_content">
                                                                <h3 class="product_title">
                                                                    <a href="product-detail.html"
                                                                        target="_blank">Organic
                                                                        Cabbage</a>
                                                                </h3>
                                                            ...
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    ...
                                                                    <img class="pic-1"
                                                                        ...
                                                                        alt="image_not_found">
                                                                    <img class="pic-2"
                                                                        src="assets/images/product/product6.png"
                                                                        alt="image_not_found">
                                                                </a>
                                                                <ul class="product_badge_group ul_li_block">
                                                                    <li><span
                                                        ...
                                                        <div class="product_layout_content bg-white position-relative">
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    href="product-detail.html" target="_blank">
                                                                    <img class="pic-1"
                                                                        src="assets/images/product/product33.png"
                                                                        alt="image_not_found">
                                                                    <img class="pic-2"
                                                                        src="assets/images/product/product8.png"
                                                                        alt="image_not_found">
                                                                </a>
                                                                <ul class="product_badge_group ul_li_block">
                                                                    <li><span
                                                        ...
                                                        <div class="product_layout_content bg-white position-relative">
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    href="product-detail.html" target="_blank">
                                                                    <img class="pic-1"
                                                                        src="assets/images/product/product34.png"
                                                                        alt="image_not_found">
                                                                    <img class="pic-2"
                                                                        src="assets/images/product/product10.png"
                                                                        alt="image_not_found">
                                                                </a>
                                                                <ul class="product_badge_group ul_li_block">
                                                                    <li><span
                                                        ...
                                                        <div class="product_layout_content bg-white position-relative">
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    href="product-detail.html" target="_blank">
                                                                    <img class="pic-1"
                                                                        src="assets/images/product/product35.png"
                                                                        alt="image_not_found">
                                                                    <img class="pic-2"
                                                                        src="assets/images/product/product3.png"
                                                                        alt="image_not_found">
                                                        ...
                                                        <div class="product_layout_content bg-white position-relative">
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    href="product-detail.html" target="_blank">
                                                                    <img class="pic-1"
                                                                        src="assets/images/product/product36.png"
                                                                        alt="image_not_found">
                                                                    <img class="pic-2"
                                                        ...
                                                        <div class="product_layout_content bg-white position-relative">
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    href="product-detail.html" target="_blank">
                                                                    <img class="pic-1"
                                                                        src="assets/images/product/product37.png"
                                                                        alt="image_not_found">
                                                                    <img class="pic-2"
                                                                        src="assets/images/product/product8.png"
                                                                        alt="image_not_found">
                                                        ...
                                                        <div class="product_layout_content bg-white position-relative">
                                                            <div class="product_image_wrap">
                                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                                    href="product-detail.html" target="_blank">
                                                                    <img class="pic-1"
                                                                        src="assets/images/product/product38.png"
                                                                        alt="image_not_found">
                                                                    <img class="pic-2"
                                                                        src="assets/images/product/product10.png"
                                                                        alt="image_not_found">
                                        ...
                                        <div class="tab-pane fade show" id="list_layout" role="tabpanel"
                                            aria-labelledby="pills-list_layout-tab" data-aos="fade-up"
                                                ...
                                                <div class="col p-0">
                                                    <div class="list_layout_wrap overflow-hidden">
                                                        <div
                                                            ...
                                                            <div class="col-lg-5">
                                                                <a class="list_layout_thumb d-flex justify-content-start"
                                                                    href="#!">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <ul class="list_layout_bade list-unstyled d-flex">
                                                                    <li><span
                                                                            class="badge_meats rounded-pill text-uppercase">Meats</span>
                                                                    </li>
                                                                    <li><span
                                                                            class="badge_discount text-white rounded-pill">-27%</span>
                                                                    </li>
                                                                </ul>
                                                                <div class="rating_wrap d-flex">
                                                                    <ul class="rating_star ul_li">
                                                                ...
                                                                <div class="product_content">
                                                                    ...
                                                                    <p class="list_layout_desc">Apparently
                                                                        we had reached a great height in the
                                                                        atmosphere, for the sky was a dead
                                                                        black, and the stars had ceased to
                                                                        twinkle.</p>
                                                                    <ul class="product_action_btns ul_li_block d-flex">
                                                                        <li><a class="tooltips" data-placement="top"
                                                    ...
                                                    <div class="list_layout_wrap overflow-hidden">
                                                        <div
                                                            ...
                                                            <div class="col-lg-5">
                                                                <a class="list_layout_thumb d-flex justify-content-start"
                                                                    href="#!">
                                                                    <img src="assets/images/product/product7.png"
                                                                        alt="image_not_found">
                                                                </a>
                                                            </div>
                                                            <div class="col-lg-7">
