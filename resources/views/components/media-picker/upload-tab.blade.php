    ...
    <div class="space-y-4">
        ...
        <label class="cursor-pointer">
          ...
          <div>
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
              <span
                class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">Click
      ...
      @if ($uploadedFiles)
        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
          <p class="text-sm font-medium text-gray-900 dark:text-white mb-2">{{ count($uploadedFiles) }} file(s) selected
          </p>
  ...
  @if (count($selected) > 0)
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-6">
      @foreach (Media::whereIn('id', $selected)->get() as $media)
        <div class="relative bg-white border-2 border-primary-600 rounded-lg overflow-hidden">
