...
<div class="mb-4 flex items-center justify-between">
    <div class="flex-1 max-w-lg">
        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search media..."
            class="shadow-sm focus:ring-primary-500 focus:ring-2 focus:border-primary-500 block w-full px-4 py-2.5 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-400">
    </div>
    <div class="ml-4">
...
@if ($uploadedFiles)
    <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
        <p class="text-sm text-blue-800 dark:text-blue-300 mb-2">{{ count($uploadedFiles) }} file(s) ready to upload</p>
        <button wire:click="uploadFiles"
            class="px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white text-sm rounded-md hover:bg-blue-700 dark:hover:bg-blue-600">
            Upload Now
        </button>
    </div>
@endif
