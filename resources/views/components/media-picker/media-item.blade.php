<div wire:click="toggleSelect({{ $media->id }})"
  class="relative group cursor-pointer bg-white border-2 rounded-lg overflow-hidden hover:border-indigo-500 transition-all @if ($isSelected) border-indigo-600 ring-2 ring-indigo-600 @else border-gray-200 @endif">
