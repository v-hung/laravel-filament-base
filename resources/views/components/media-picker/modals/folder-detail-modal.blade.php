<x-media-picker.base-modal title="{{ __('media.folder.details_title') }}" maxWidth="2xl">
    ...
    <div class="text-center mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {{ __('media.folder.location_label') }}
        ...
        <div class="mt-2 flex items-center justify-center gap-4 text-sm">
            <div class="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
                ...
                <span>{{ trans_choice('media.folder.folders_count', $this->detailFolderSubfoldersCount, ['count' => $this->detailFolderSubfoldersCount]) }}</span>
            </div>
            <div class="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>{{ trans_choice('media.folder.files_count', $this->detailFolderMediaCount, ['count' => $this->detailFolderMediaCount]) }}</span>
            </div>
        </div>
    </div>
    ...
    <!-- Editable Fields -->
    <div class="space-y-4">
        <x-media-picker.form.input :label="__('media.folder.name_label')" name="detailFolderName" wire:model="detailFolderName"
            :placeholder="__('media.folder.name_placeholder')" required />
    </div>
    ...
    <div
        ...
        <div>
            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ __('media.folder.delete_title') }}</p>
            <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('media.folder.delete_hint') }}</p>
        </div>
