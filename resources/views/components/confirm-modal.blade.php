...
<div x-data="{
    ...
    @open-{{ $name }}.window="
        ...
        show = true;
    "
    x-show="typeof show !== 'undefined' && show" x-cloak style="display: none;" class="fixed inset-0 z-50 overflow-y-auto"
    aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <!-- Background overlay -->
        <div x-show="typeof show !== 'undefined' && show" x-transition:enter="ease-out duration-300"
