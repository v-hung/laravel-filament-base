...
export default function Home() {
    ...
    const features = [
        { icon: Icons.Leaf, label: t('home.sustainableMaterials') },
        { icon: Icons.Couch, label: t('home.designForLife') },
        { icon: Icons.Hammer, label: t('home.craftedByExperts') },
        { icon: Icons.Truck, label: t('home.convenientDelivery') },
    ];
    return (
        <AppLayout>
            <AppHead />
