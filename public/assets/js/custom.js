...
(function ($) {
    ...
    if ($("#slider-range").length) {
        ...
        var price_min_el = $("#price_min");
        var price_max_el = $("#price_max");

        var minPrice = parseInt(slider.data("min"));
        var maxPrice = parseInt(slider.data("max"));

        // Giá khởi tạo từ hidden input (nếu đã submit trước đó)
        var initMin = parseInt(price_min_el.val()) || minPrice;
        var initMax = parseInt(price_max_el.val()) || maxPrice;
        ...
        slider.slider({
            ...
            slide: function (event, ui) {
                ...
                price_min_el.val(ui.values[0]);
                price_max_el.val(ui.values[1]);
            },
        });

        // Gán giá ban đầu hiển thị
        $("#amount").val(
            slider.slider("values", 0).toLocaleString("vi-VN") +
                " ₫ - " +
                slider.slider("values", 1).toLocaleString("vi-VN") +
                " ₫"
        );
    }
    ...
    var $slideshow4_slider = $(".slideshow4_slider");
    var slideshow4_sliderCount = $slideshow4_slider.find("li").length;
    ...
    $slideshow4_slider.slick({
        ...
        infinite: false,
        autoplay: false,
        // infinite: slideshow4_sliderCount > 5,
        slidesToShow: 5,
        // centerMode: true,
        // centerPadding: "0px",
        // variableWidth: true,
                ...
                datasets: [
                    {
                        label: "Invest",
                        data: [
                            80, 30, 100, 60, 70, 90, 85, 95, 20, 75, 99, 110,
                        ],
                    ...
                    },
                    {
                        label: "Revenue",
                        data: [
                            100, 60, 130, 90, 50, 120, 70, 110, 40, 80, 125,
                            135,
                        ],
    ...
    var BAChartJobErrColors = ["#ff9801", "#7cb31a", "#fec107", "#01a1ff"];
